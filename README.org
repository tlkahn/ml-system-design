...
- Asymmetric metrics:
  ...
  #+end_src
    ...
    Asymmetric metrics like precision, recall, and F1 score treat false positives and false negatives differently due to their distinct formulas. To understand their asymmetry and effects, let's break down each metric:
    ...
    - The asymmetry of these metrics can be observed in situations where one metric is high while the other is low. For example, a model with high precision but low recall is good at avoiding false positives but misses many actual positive instances. Conversely, a model with high recall but low precision correctly identifies most positive instances but generates many false positives.

    - Understanding these asymmetries helps you choose an appropriate metric based on your specific problem or application's requirements. For instance, in a medical diagnosis system, you might prioritize high recall to avoid missing positive cases, even if it means more false positives. Conversely, in a spam detection system, you might focus on high precision to reduce false positives, ensuring that legitimate emails don't end up in the spam folder.
*** Baselines
...
* Footnotes
[fn:17]
https://arxiv.org/abs/2208.09827
https://arxiv.org/abs/1403.3375
[fn:16]
...
https://web.archive.org/web/20120609232923/http://metaoptimize.com/qa/questions/6943/what-is-the-hashing-trick
...
[fn:9]
https://www.youtube.com/watch?v=Nw77sEAn_Js https://medium.com/@quocnle/how-we-scaled-bert-to-serve-1-billion-daily-requests-on-cpus-d99be090db26
[fn:7]
...
[fn:4]
Using 16 bits to represent a float is called half precision. Instead of using floats, you can have a model entirely in integers; each integer takes only 8 bits to represent. This method is also known as "fixed point."
