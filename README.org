...
To calibrate your models, a common method is Platt scaling, which is implemented in scikit-learn with sklearn.calibration.CalibratedClassifierCV.
...
[fn:3] Source: Kabir Nagrecha, Systems for Parallel and Distributed Large-Model Deep Learning Training
